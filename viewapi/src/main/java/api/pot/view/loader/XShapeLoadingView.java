...
public class XShapeLoadingView extends View {
    ...
    public XShapeLoadingView(Context context) {
        super(context);
        init(context);
    }

    public XShapeLoadingView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public XShapeLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public XShapeLoadingView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
