...
public class XShapeLoadingDialog extends Dialog{

    private XLoadingView mLoadingView;

    private Builder mBuilder;

    private XShapeLoadingDialog(Builder builder) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLoadingView = (XLoadingView) findViewById(R.id.loadView);
    ...
    public static class Builder{
        ...
        public XShapeLoadingDialog build(){
            return new XShapeLoadingDialog(this);
        }

        public XShapeLoadingDialog show(){
            XShapeLoadingDialog dialog = build();
            dialog.show();
            return dialog;
        }
    }
