...
public class XLoadingView extends LinearLayout {
    ...
    private XShapeLoadingView mShapeLoadingView;
    ...
    public XLoadingView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mShapeLoadingView = (XShapeLoadingView) findViewById(R.id.shapeLoadingView);
